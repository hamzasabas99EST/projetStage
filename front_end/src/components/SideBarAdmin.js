        ...
        return (
            <div className="sidebar">
                ...
                <ul>
                    ...
                    <li><Link to="/EspaceAdmin/Rules"><FontAwesomeIcon icon={faStream} /> Des régles</Link>  </li>
                    <li><Link to="/EspaceAdmin/Reservations"><FontAwesomeIcon icon={faCalendarWeek} /> Les réservations</Link></li>
                    <li><Link to="/EspaceAdmin/Games"><FontAwesomeIcon icon={faFutbol} /> Mes Matches</Link></li>
